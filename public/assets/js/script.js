...
// Control name field
const signupName = document.querySelector("input[name='signup-name']");
signupName.addEventListener("focusout", function(e) {
    if (signupName.value.length < 3) {
        signupName.style.borderColor = "red";
        error = true;
        divResult.innerHTML = "";
        divResult.innerHTML = "Name must be at least 3 characters long";
    } else {
...
// control email field
const signupEmail = document.querySelector("input[name='signup-email']");
...
const signupTelephone = document.querySelector("input[name='signup-telno']");
...
const signupPassword = document.querySelector("input[name='signup-passkey']");
...
const signupConfirmPassword = document.querySelector(
    "input[name='signup-passkey-confirm']"
);
...
const signupTerms = document.querySelector("input[name='signup-term']");
...
const signupSubmit = document.querySelector("button[name='signup-submit']");
