...
}) // end addEventListener password

const confirmPassword = document.querySelector("input[name='signup-passkey-confirm']");
...
}) // end addEventListener confirm password
...
}) // end addEventListener Submt button